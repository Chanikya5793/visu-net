    ...
    <Container maxWidth="xl">
      <Box sx={{ mb: 4 }}>
        ...
        >
          ...
          <Typography color="text.primary">Neural Network</Typography>
        </Breadcrumbs>
      </Box>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
        ...
        <Paper elevation={1} sx={{ p: 3, borderRadius: 2 }}>
          <Typography variant="h6" gutterBottom>Dataset Selection</Typography>
          <Divider sx={{ mb: 2 }} />
          ...
          <>
            ...
            <Paper elevation={1} sx={{ p: 3, borderRadius: 2 }}>
              ...
              <Grid container spacing={3}>
                <Grid item xs={12} md={6}>
                  <DatasetViewer dataset={dataset} title="Default Dataset" />
                </Grid>
                <Grid item xs={12} md={6}>
                  <DatasetViewer 
                    dataset={dataset} 
              ...
              <Box sx={{ mt: 3 }}>
                <Box sx={{ display: 'flex', gap: 2 }}>
                  ...
                  <Button
                    ...
                    disabled={customDataset.length === 0 || isTraining}
                  >
                    Use Custom Dataset
                  </Button>
                </Box>
            ...
            <Paper elevation={1} sx={{ p: 3, borderRadius: 2 }}>
              ...
              <TrainingControls 
                ...
                onStop={handleStop}
                onReset={handleReset}
                currentDataset={isUsingCustomDataset ? 'custom' : 'default'}
              />
            </Paper>
            ...
            {!isTraining && iteration > 0 && (
              <Paper elevation={1} sx={{ p: 3, borderRadius: 2 }}>
                <Typography variant="h6" gutterBottom>Model Testing</Typography>
                <Divider sx={{ mb: 2 }} />
                <TestModelButton 
            ...
            <Paper elevation={1} sx={{ p: 3, borderRadius: 2 }}>
              ...
              <Divider sx={{ mb: 2 }} />
              <Box sx={{ display: 'flex', gap: 2 }}>
                <Tooltip title="Download the trained model configuration and dataset">
                  <span>
                    <Button
                      variant="contained"
